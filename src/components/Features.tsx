...
export default function Features() {
    const features = [
        ...
        {
            title: "Learn Hindi Through English",
            description:
                "Master Hindi conversation through English using familiar concepts. Our online course makes learning Hindi grammar and vocabulary simple and accessible.",
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
